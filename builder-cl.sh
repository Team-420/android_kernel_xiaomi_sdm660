...
if [ ! -d $ANYKERNEL_DIR ]; then
    ...
    git clone https://github.com/Team-420/AnyKernel3 -b whyred ../anykernel
fi
if [ ! -d $KERNELBUILDS_DIR ]; then
    echo "builds directory does not exists, cloning now..."
    git clone https://github.com/Thiviyan/Builds ../kernelbuilds
fi
}
...
make exynos7870-j7y17lte_defconfig  ARCH="${ARCH}"
